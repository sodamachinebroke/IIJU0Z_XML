...
public class DomReadIIJU0Z {
    ...
    public static void main(String[] args) {
        ...
        Document doc = introduceFile(xmlFile); //This one makes the documentBuilderFactory and stuff. Looks nicer to read, the function is below
    ...
    private static void saveDocumentToFile(Document doc, String fileName) { //This one does a bunch of do-hickeys to save the file. Ultimately it does save it as specified in the function call
        try {
    ...
    private static void listData(NodeList nodeList, String indent) { //This one lists everything. Essentially the most important in terms of non-IO functions
        indent += "\t";
